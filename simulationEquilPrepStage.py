...
for cycle in np.arange(0,2):
    ...
    gamdRestart.write("(1)Boosted VfinalD:\t" + str(dihedralEnergy[-1]) + "\n")
    gamdRestart.write("(2)Boosted VminD:\t" + str(min(dihedralEnergy)) + "\n")
    gamdRestart.write("(3)Boosted VmaxD:\t" + str(max(dihedralEnergy)) + "\n")
    gamdRestart.write("(4)Average k0D:\t" + str(1.0) + "\n")
    gamdRestart.write("(5)Final k0D:\t" + str(1.0) + "\n")
    gamdRestart.write("(6)Boosted VfinalP:\t" + str(totalEnergy[-1]) + "\n")
    gamdRestart.write("(7)Boosted VminP:\t" + str(min(totalEnergy)) + "\n")
    gamdRestart.write("(8)Boosted VmaxP:\t" + str(max(totalEnergy)) + "\n")
    ...
    simulation.reporters.append(DCDReporter("equil-prep-"+str(cycle)+".dcd", 500))
    simulation.reporters.append(ExpandedStateDataReporter(system, "equil-prep-"+str(cycle)+".mdout", 500, step=True, temperature=True,
