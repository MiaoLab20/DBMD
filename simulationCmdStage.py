...
inpcrd = AmberInpcrdFile("gcaa_unfold.crd")
...
simulation.reporters.append(DCDReporter("cmd.dcd", 500))
simulation.reporters.append(ExpandedStateDataReporter(system, "cmd.mdout", 100, step=True, temperature=True,
                                                      brokenOutForceEnergies=True, potentialEnergy=True,
                                                      totalEnergy=True, density=True, separator="\t",
                                                      speed=True, remainingTime=True, totalSteps=12500000))
