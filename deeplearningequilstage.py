...
while (anharmdual > 1e-2) and iter <= 10:
    ...
    if anharmdual <= 1e-2:
        ...
        gamdRestart.write("(1)Boosted VfinalD:\t" + str(Xdih[-1]) + "\n")
        gamdRestart.write("(2)Boosted VminD:\t" + str(min(dihedralEnergy[-10000:])) + "\n")
        gamdRestart.write("(3)Boosted VmaxD:\t" + str(max(dihedralEnergy[-10000:])) + "\n")
        gamdRestart.write("(4)Maximum k0D:\t" + str(max(dihedralfc0s)) + "\n")
        gamdRestart.write("(5)Average k0D:\t" + str(np.mean([k0D for k0D in dihedralfc0s if np.isnan(k0D) == False])) + "\n")
        gamdRestart.write("(6)Boosted VfinalP:\t" + str(Xtot[-1]) + "\n")
        gamdRestart.write("(7)Boosted VminP:\t" + str(min(totalEnergy[-10000:])) + "\n")
        gamdRestart.write("(8)Boosted VmaxP:\t" + str(max(totalEnergy[-10000:])) + "\n")
        gamdRestart.write("(9)Maximum k0P:\t" + str(max(totalfc0s)) + "\n")
        gamdRestart.write("(10)Average k0P:\t" + str(np.mean([k0P for k0P in totalfc0s if np.isnan(k0P) == False])) + "\n")
        gamdRestart.close()
