...
class DualDeepLearningGaMDProduction(CustomIntegrator):
    def __init__(self, dt=0.002*picoseconds, temperature=300*kelvins):
        ...
        self.setGlobalVariableByName("VminD", min_dihedral)
        self.setGlobalVariableByName("VmaxD", max_dihedral)
        ...
        self.beginIfBlock("DihedralRefEnergy > 1.25*VmaxD")
        ...
        self.setGlobalVariableByName("VminP", min_total)
        self.setGlobalVariableByName("VmaxP", max_total)
        ...
        self.beginIfBlock("TotalRefEnergy > 1.25*VmaxP")
